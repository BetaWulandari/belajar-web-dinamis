    ...
    <nav>
        <div class="container">
            ...
            <ul class="links">
                ...
                <li><a href="page/kegiatan.php">Kegiatan</a></li>
                <li><a href="page/organisasi.php">Organisasi</a></li>
                <li><a href="page/informasi-desa.php">Info Desa</a></li>
                <li><a href="page/dokumentasi.php">Dokumentasi</a></li>
                <li><a href="page/kontak.php">Kontak</a></li>
            </ul>
